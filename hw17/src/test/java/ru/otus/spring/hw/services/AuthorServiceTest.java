...
class AuthorServiceTest {
    ...
    void findById_NotFound() {
        ...
        Assertions.assertThatThrownBy(() -> authorService.findById(nonExistentAuthorId))
                .isInstanceOf(EntityNotFoundException.class)
                .hasMessage("Author with id %d not found".formatted(nonExistentAuthorId));

        Mockito.verify(authorRepository, Mockito.times(1)).findById(nonExistentAuthorId);
    }
